...
func MapRestaurantRoutes(restaurantGroup *gin.RouterGroup, restaurantHandler interfaces.RestaurantHandler) {
	...
	restaurantGroup.GET("/balance", restaurantHandler.GetBalance())
	restaurantGroup.GET("/:restaurant_id/detail", restaurantHandler.GetByID())
	...
	restaurantGroup.PATCH("/editname/:id", restaurantHandler.UpdateName())
}
